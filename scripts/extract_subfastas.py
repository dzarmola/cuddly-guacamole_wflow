...
def uuu(p, s, e):
    return p[overlapl(p[0][0], p[0][1], s, e) < overlapl(p[1][0], p[1][1], s, e)]
...
def parse_results(HHRS, cores):
    ...
    for hhr in HHRS:
        ...
        for hit in results.hits:
            ...
            RESULTS['hits'].append(
                (id, (s, e), (er0, er1), hit.eval, (s, match, e, pdb_s + i, pdb_core, pdb_s + proper_length(pdb_core))))
