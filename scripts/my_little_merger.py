...
if __name__ == "__main__":
    ...
    parser.add_argument('--cluster_file', nargs=1, type=str, default="",
                        help='Cluster defining file: each cluster in one line')
    parser.add_argument('--save_name', nargs=1, type=str,
                        default="savepoint_{}.txt".format(time.strftime("%Y%m%d-%H%M%S")),
                        help='Custom savepoint name')
    parser.add_argument('--plot_name', nargs=1, type=str,
                        default="merged_alignment_{}.png".format(time.strftime("%Y%m%d-%H%M%S")),
